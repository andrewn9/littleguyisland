...
func is_built(t: EntityType) -> bool:
	return t == EntityType.HOUSING or t == EntityType.FARM or t == EntityType.WELL or t == EntityType.FARM_BUILDING
...
func prosperous():
	return population > 0 and food >= population * food_per_person * birth_food_ratio and avg_happiness >= birth_happiness and not overcrowded()
